...
(async ()=>{
  ...
  <section class="hero-panel home-hero-upgraded">
    ...
    <div class="hero-copy">
      ...
      <p>الصفحة الرئيسية الآن أكثر ترتيبًا، مع بطاقات أقوى، بحث أسرع، وفرز أسهل بين جميع مدن ليبيا حتى يصل الزبون للإعلان المناسب بسرعة.</p>
    </div>
    ...
    <div class="search-panel home-search-panel">
      <div class="search-grid home-search-grid">
        ...
        ${customSelect('المدينة', 'كل المدن', ['كل المدن','طرابلس','بنغازي','مصراتة','الزاوية','زليتن','سبها','سرت','الخمس','درنة','البيضاء','طبرق','أجدابيا','المرج','صبراتة','غريان','الجبل الغربي','نالوت','يفرن','زوارة','بني وليد','ترهونة','العجيلات','رقدالين','الكفرة','هون','ودان','مرزق','غات','أوباري','زواره','راس لانوف','البريقة','شحات','سوسة','القبة','توكرة','تاورغاء','المردوم','مسلاتة','سلوق'], 'home-city')}
