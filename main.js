...
(async ()=>{
  ...
  <section class="hero-panel home-hero-upgraded">
    ...
    <div class="hero-copy">
      <h3>براتشو كار بشكل أوضح وتنظيم أقرب للسوق المفتوح</h3>
      <p>واجهة بسيطة وواضحة لعرض السيارات وقطع الغيار والخدمات مع لمسة براتشو الخاصة.</p>
    </div>
    ...
    <div class="search-panel home-search-panel">
      <div class="search-grid home-search-grid">
        ...
        ${customSelect('القسم', 'كل الأقسام', ['كل الأقسام','سيارات','قطع غيار','كماليات سيارات','خدمات'], 'home-cat')}
  ...
  <section class="section">
    <div class="section-head">
      <div>
        ...
        <p>أقسام مرتبة وسريعة تساعدك توصل للإعلان المطلوب بسهولة.</p>
      </div>
    ...
    <div class="category-list home-cats-upgraded">
      ...
      ${categoryCard('🛠️','الخدمات','خدمات، كهرباء، قطر، وإنقاذ سريع.','services.html')}
    </div>
  </section>
