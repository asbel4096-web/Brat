...
(async ()=>{
  ...
  <section class="hero-panel home-hero-upgraded">
    ...
    <div class="hero-copy">
      <h3>سوق سيارات وخدمات بشكل أوضح وأفخم وأسرع</h3>
      <p>الصفحة الرئيسية الآن أكثر ترتيبًا، مع بطاقات أقوى، بحث أسرع، وفرز أسهل حتى يصل الزبون للإعلان المناسب بسرعة.</p>
    </div>
    ...
    <div class="search-panel home-search-panel">
      <div class="search-grid home-search-grid">
        ...
        ${customSelect('المدينة', 'كل المدن', ['كل المدن','طرابلس','مصراتة','بنغازي','الزاوية','زليتن'], 'home-city')}
