...
<main class="page">
<section class="hero"><div class="container"><div class="hero-card"><div class="hero-inner">
<div class="hero-tags">
...
<p class="hero-text">واجهة أنيقة وهوية واضحة لبراتشو كار مع بطاقات إعلانات مرتبة أكثر، مناسبة للجوال وقريبة من أسلوب التطبيقات الكبرى.</p>
...
<div class="search-shell"><div class="search-grid">
<label class="field"><input placeholder="ابحث: سوناتا 2016 / كمبيو / فحص بطارية"></label>
<label class="field"><select onchange="if(this.value) location.href=this.value"><option value="">كل الأقسام</option><option value="cars.html">سيارات</option><option value="parts.html">قطع غيار</option><option value="parts.html">كماليات</option><option value="services.html">ميكانيكي متنقل</option></select></label>
<label class="field"><select><option>كل المدن</option><option>طرابلس</option><option>مصراتة</option><option>بنغازي</option></select></label>
<button class="btn" onclick="location.href='cars.html'">بحث</button>
</div></div>
</div></div></div></section>
<section class="section"><div class="container">
<div class="section-head"><div><h2>الأقسام الرئيسية</h2><p>نسخة حديثة مخصصة لبراتشو كار، وليست سوقًا عامًا.</p></div></div>
...
<section class="section"><div class="container">
<div class="section-head"><div><h2>إعلانات مميزة</h2><p>بطاقات جديدة بشكل مرتب أقرب لأسلوب الحراج مع لمسة براتشو كار.</p></div><a class="pill" href="my-ads.html">كل الإعلانات</a></div>
