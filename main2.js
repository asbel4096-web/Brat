...
<main class="page">
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="category-grid">
        ...
        <div class="section-card"><div class="mini">القسم 3</div><h4>الميكانيكي المتنقل</h4><p>فحص، كهرباء، تغيير زيوت، إنقاذ سريع، بطاريات، وخدمة عند الزبون.</p></div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="section-head">
        <div><h3 class="section-title">تصفح سريع</h3><p class="section-desc">واجهة نظيفة ومناسبة للجوال</p></div>
      </div>
  ...
  <section class="section">
    <div class="container">
      <div class="section-head">
        <div><h3 class="section-title">إعلانات مميزة</h3><p class="section-desc">أفضل السيارات والقطع والخدمات</p></div>
